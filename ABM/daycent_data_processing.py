...
dir_with_cvs = os.path.join(params.dir_loc,"data","daycent data")
os.chdir(dir_with_cvs)


#loc_dir = os.path.join(params.dir_loc,"data","GIS_upsang") #Adjusting to upper sangamon
loc_dir = os.path.join(params.dir_loc,"data","GIS")
farmer_map = gpd.read_file(os.path.join(loc_dir,'farms_sagamon_farm1000_with_urban'))
